...
const fireKeyframes = [
  {t:0,x:54.9,y:69.6,w:11.9,h:28.6},{t:0.11,x:48.7,y:62.5,w:11.9,h:28.6},{t:0.22,x:34.8,y:46.7,w:11.9,h:28.6},
...
function DetectionDemo() {
  ...
  useEffect(() => {
    ...
    const run = async () => {
      ...
      // Stay in tracking mode for the rest of the video loop
      await wait(12000);
